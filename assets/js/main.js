...
function start() {
    if (onlyOnce) {
        ...
        if (clientsCounter && servicesCounter && doctorsCounter) {
            animateValue(clientsCounter, 0, clientsCounter.innerText, 5000);
            animateValue(servicesCounter, 0, servicesCounter.innerText, 5000);
            animateValue(doctorsCounter, 0, doctorsCounter.innerText, 5000);
        }
    }
}
